...
public sealed class UiLocalizer
{
    private static readonly IReadOnlyDictionary<string, Translation> Texts = new Dictionary<string, Translation>
    {
        ...
        ["Nav.ActivateHelper"] = new("Als Helfer aktivieren", "Activate as helper"),
        ...
        ["Helpers.Description"] = new("Beschreibung", "Description"),
        ["Helpers.Title"] = new("Titel", "Title"),
        ["Helpers.ActivationEyebrow"] = new("Helferprofil", "Helper profile"),
        ["Helpers.ActivationHeadline"] = new("Als Helfer aktivieren", "Activate as helper"),
        ["Helpers.EditHeadline"] = new("Helferprofil bearbeiten", "Edit helper profile"),
        ["Helpers.ActivationText"] = new("Hier kannst du dein Profil anlegen oder aktualisieren.", "Here you can create or update your profile."),
        ["Helpers.LoginRequiredHeadline"] = new("Anmeldung erforderlich", "Login required"),
        ["Helpers.LoginRequiredText"] = new("Bitte zuerst anmelden, um ein Helferprofil anzulegen.", "Please log in first to create a helper profile."),
        ["Helpers.StatusEyebrow"] = new("Status", "Status"),
        ["Helpers.StatusHeadline"] = new("Dein Helferstatus", "Your helper status"),
        ["Helpers.NotActiveYet"] = new("Du bist noch nicht als Helfer aktiviert.", "You are not active as a helper yet."),
        ["Helpers.AlreadyActive"] = new("Dein Profil ist bereits aktiv und kann hier geändert werden.", "Your profile is already active and can be updated here."),
        ["Helpers.ActivateButton"] = new("Als Helfer aktivieren", "Activate as helper"),
        ["Helpers.UpdateButton"] = new("Profil aktualisieren", "Update profile"),
        ["Helpers.Saving"] = new("Speichern...", "Saving..."),
        ["Helpers.Activated"] = new("Helferprofil wurde aktiviert.", "Helper profile has been activated."),
        ["Helpers.Updated"] = new("Helferprofil wurde aktualisiert.", "Helper profile has been updated."),
        ["Helpers.AppUserMissing"] = new("Kein Benutzerprofil gefunden. Bitte zuerst registrieren/anmelden.", "No app user profile found. Please register/sign in first."),
        ["Helpers.SaveFailed"] = new("Speichern fehlgeschlagen. Bitte erneut versuchen.", "Saving failed. Please try again."),
